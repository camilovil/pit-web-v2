...
function renderIndex(posts) {
  ...
  const destCss = `    /* El destacado es un carrusel: mismas piezas que el de cursos de la home
    ...
    /* Altura reservada: las portadas mezclan fotos horizontales y afiches 4:5.
       Sin una fila estable, el primer afiche vertical que terminaba de cargar
       hacía crecer todo el carrusel unos 190px mientras el usuario lo miraba. */
    .foro-dest { height: clamp(520px, 44vw, 600px); scroll-snap-align: center; background: var(--pit-paper-pure); border: 1px solid var(--pit-blue); border-radius: var(--pit-radius); display: grid; grid-template-columns: 1.5fr 1fr; overflow: hidden; gap: 0; min-width: 0; }
    ...
    @media (max-width: 820px) { .foro-dest { height: auto; grid-template-columns: minmax(0, 1fr); } }
