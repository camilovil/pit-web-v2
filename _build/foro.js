  ...
  return blocks.map(b => {
    ...
    if (img) {
      return `<figure style="margin: 0 0 28px;">
          ...
          ${img[3] ? `<figcaption style="font-family: var(--pit-font-mono); font-size: var(--txt-2xs); letter-spacing: 0.06em; color: var(--pit-ink-40); margin-top: 10px;">${img[3]}</figcaption>` : ''}
        </figure>`;
    }
    if (b.startsWith('> ')) {
      ...
      <article style="max-width: 68ch;">
        ...
        <div style="display: flex; align-items: center; gap: 14px; border-top: 2px solid var(--pit-ink); padding-top: 20px; margin-top: 28px;">
          ...
          <div>
            ...
            <div style="font-family: var(--pit-font-mono); font-size: var(--txt-2xs); letter-spacing: 0.06em; color: var(--pit-ink-40);">M.N. 86.498 · INSTRUCTOR AUTORIZADO PIT</div>
          </div>
        </div>
      </article>
      ...
      <article class="m-stack0" style="background: var(--pit-paper-pure); border: 1px solid var(--pit-blue); border-radius: var(--pit-radius); margin-top: 24px; display: grid; grid-template-columns: 1.5fr 1fr; overflow: hidden; gap: 0;">
        <div class="m-pad" style="padding: 40px 44px;">
          <div style="display: flex; gap: 10px; align-items: center; margin-bottom: 18px; flex-wrap: wrap;">
            ...
            <span style="font-family: var(--pit-font-mono); font-size: var(--txt-xs); letter-spacing: 0.06em; color: var(--pit-ink-40);">SEMANA ${featured.semana.replace('S', '')} · ${featured.fechaLabel}</span>
          </div>
          ...
          <div style="display: flex; gap: 20px; align-items: center;">
            ...
            <span style="font-family: var(--pit-font-mono); font-size: var(--txt-xs); letter-spacing: 0.06em; color: var(--pit-ink-40);">${featured.lectura} MIN DE LECTURA</span>
          </div>
        </div>
  ...
  <section id="pregunta" style="padding: var(--pit-section-padding); background: var(--pit-ink); color: var(--pit-paper);">
    <div class="m-stack" style="max-width: var(--pit-content-max); margin: 0 auto; display: grid; grid-template-columns: 1fr 1.2fr; gap: 64px; align-items: start;">
      <div>
        ...
        <p style="font-size: var(--txt-md); line-height: 1.65; color: var(--pit-ink-20); margin: 0; max-width: 48ch;">Ricardo selecciona y responde preguntas cada semana. Todas se revisan antes de publicarse y se publican sin nombre ni datos personales. Dejá tu email y te avisamos apenas esté la respuesta.</p>
      ...
      <div id="foro-ok" tabindex="-1" style="display: none; background: rgba(255,255,255,0.04); border: 1px solid var(--pit-blue); border-radius: var(--pit-radius); padding: 40px 36px; box-sizing: border-box; min-width: 0;">
        ...
        <p id="foro-sent-nl" style="display: none; font-family: var(--pit-font-mono); font-size: var(--txt-xs); letter-spacing: 0.04em; color: var(--pit-blue); margin: 16px 0 0;">✓ QUEDASTE SUSCRIPTO AL NEWSLETTER</p>
