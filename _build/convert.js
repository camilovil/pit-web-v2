...
const LINKS = {
  ...
  'Publicacion Foro PIT.dc.html': 'foro-publicacion.html',
...
const PAGES = [
  ...
  { mode: 'core', src: 'cores/foro.html', out: 'foro.html', active: 'foro.html',
    title: 'Foro PIT — Ricardo responde, todas las semanas',
    desc: 'Preguntas de pacientes y profesionales sobre PIT, respondidas cada semana por el Dr. Ricardo D. Frusso.' },
  { mode: 'core', src: 'cores/foro-publicacion.html', out: 'foro-publicacion.html', active: 'foro.html',
    title: 'Foro PIT — publicación semanal · Dr. Frusso',
    desc: 'Publicación del foro semanal de PIT: preguntas respondidas por el Dr. Ricardo D. Frusso.' },
